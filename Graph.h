...
class Graph {
    ...
    public:
        vector<tuple<double, string , string>> edgeList;
        ...
        void dfs(const string& node_label, const double& threshold, unordered_set<string>& visited, vector<string>& component);

        string find(string x);

        void union_string(unordered_map<string, int>& rank, string x, string y);
